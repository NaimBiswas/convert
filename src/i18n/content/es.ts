...
export const es: ConverterDataMap = {
  'json-to-csv': {
    meta: {
  ...
  features: {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: 'Convierte imágenes a PNG, JPG o WebP en tu navegador. Control de calidad, vista previa de dimensiones y descarga instantánea.',
        link: '/image-converter',
        icon: 'image',
      },
      {
        title: 'Ver metadatos de imagen',
        desc: 'Inspecciona EXIF, GPS, IPTC, XMP e ICC ocultos en tus fotos: ajustes de cámara, ubicación, fechas y más.',
        link: '/image-metadata-viewer',
        icon: 'image',
      },
      {
        title: 'Eliminar metadatos',
        desc: 'Elimina EXIF, GPS y otros datos ocultos antes de compartir. Sin pérdida, privado y totalmente en tu navegador.',
  ...
  formats: {
    ...
    cards: [
      ...
      },
      {
        label: 'PNG',
        targets: ['JPG', 'WebP'],
        tag: 'Gráficos web, logos, transparencia',
      },
      {
        label: 'JPG',
        targets: ['PNG', 'WebP'],
        tag: 'Fotos, compartir, la web',
      },
      {
        label: 'WebP',
        targets: ['JPG', 'PNG'],
        tag: 'Imágenes web pequeñas y rápidas',
      },
    ],
  },
};
